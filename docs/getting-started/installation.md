...
wget https://github.com/walidfaour/pwndoc-mcp-server/releases/latest/download/pwndoc-mcp-server_1.1.0_amd64.deb

# Install
sudo dpkg -i pwndoc-mcp-server_1.1.0_amd64.deb

# Or with apt (handles dependencies)
sudo apt install ./pwndoc-mcp-server_1.1.0_amd64.deb
```
...
wget https://github.com/walidfaour/pwndoc-mcp-server/releases/latest/download/pwndoc-mcp-server-1.1.0-1.x86_64.rpm

# Install with yum
sudo yum localinstall pwndoc-mcp-server-1.1.0-1.x86_64.rpm

# Or with dnf
sudo dnf install ./pwndoc-mcp-server-1.1.0-1.x86_64.rpm
```
